...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        menu_item_ingredients_data = {
            ...
            "Penne Arrabbiata": [
                {"ingredient_name": "Penne", "quantity_required": 100},
                {"ingredient_name": "Tomato-Sauce", "quantity_required": 150},
                {"ingredient_name": "Garlic", "quantity_required": 5},
                {"ingredient_name": "Onions-Red", "quantity_required": 30},
                {"ingredient_name": "Chili-Flakes", "quantity_required": 2},
            ...
            "Lasagna": [
                {"ingredient_name": "Lasagna-Sheets", "quantity_required": 200},
                {"ingredient_name": "Beef-Ground", "quantity_required": 150},
            ...
            "Linguine with Clams": [
                ...
                {"ingredient_name": "Clams", "quantity_required": 150},
            ...
            "Pesto Penne": [
                {"ingredient_name": "Penne", "quantity_required": 100},
                {"ingredient_name": "Basil", "quantity_required": 50},
                {"ingredient_name": "Parmesan-Cheese", "quantity_required": 30},
